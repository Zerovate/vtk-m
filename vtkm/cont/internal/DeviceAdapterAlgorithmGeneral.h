...
public:
  ...
  VTKM_NEVER_EXPORT static vtkm::exec::internal::TaskSingular<
    DeviceTag, WorkletType, OutToInPortalType, VisitPortalType, ThreadToOutPortalType, InputDomainType, ExecutionObjectTypes...>
  ...
  {
    using Task = vtkm::exec::internal::TaskSingular<
    DeviceTag, WorkletType, OutToInPortalType, VisitPortalType, ThreadToOutPortalType, InputDomainType, ExecutionObjectTypes...>;
    return Task(worklet, outToInPortal, visitPortal, threadToOut, inputDomain, std::forward<ExecutionObjectTypes>(executionObjects)...);
  }
