...
public:
  ...
  static vtkm::exec::serial::internal::TaskTiling1D MakeTask(
  ...
  {
    return vtkm::exec::serial::internal::TaskTiling1D(
      worklet,
      outToInPortal,
      visitPortal,
      threadToOutPortal,
  ...
  template <typename WorkletType,
            ...
            typename ThreadToOutPortalType,
            typename... ExecutionObjectTypes>
  static vtkm::exec::serial::internal::TaskTiling3D MakeTask(
    const WorkletType& worklet,
    const OutToInPortalType& outToInPortal,
    const VisitPortalType& visitPortal,
    const ThreadToOutPortalType& threadToOutPortal,
    ...
    ExecutionObjectTypes&&... executionObjects)
  {
    return vtkm::exec::serial::internal::TaskTiling3D(
      worklet,
      outToInPortal,
      visitPortal,
      threadToOutPortal,
