...
public:
  ...
  static vtkm::exec::openmp::internal::TaskTiling1D MakeTask(
  ...
  {
    return vtkm::exec::openmp::internal::TaskTiling1D(
      worklet,
      outToInPortal,
      visitPortal,
      threadToOutPortal,
  ...
  template <typename WorkletType,
            ...
            typename ThreadToOutPortalType,
            typename... ExecutionObjectTypes>
  static vtkm::exec::openmp::internal::TaskTiling3D MakeTask(
    const WorkletType& worklet,
    const OutToInPortalType& outToInPortal,
    const VisitPortalType& visitPortal,
    const ThreadToOutPortalType& threadToOutPortal,
    ...
    ExecutionObjectTypes&&... executionObjects)
  {
    return vtkm::exec::openmp::internal::TaskTiling3D(
      worklet,
      outToInPortal,
      visitPortal,
      threadToOutPortal,
