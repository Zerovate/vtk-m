...
public:
                           ...
                           vtkm::Id numInstances)
  {
    ...
    if (GetStderrLogLevel() >= vtkm::cont::LogLevel::KernelLaunches)
    {
      ...
      VTKM_CUDA_CALL(cudaFuncGetAttributes(&empty_kernel_attrs,
                                           cuda::internal::TaskStrided1DLaunch<TaskType>));
      LogKernelLaunch(empty_kernel_attrs, task.GetFunctorTypeId(), blocks, threadsPerBlock, numInstances);
    }
#endif
                           ...
                           vtkm::Id3 rangeMax)
  {
    ...
    if (GetStderrLogLevel() >= vtkm::cont::LogLevel::KernelLaunches)
    {
      cudaFuncAttributes empty_kernel_attrs;
      VTKM_CUDA_CALL(cudaFuncGetAttributes(&empty_kernel_attrs,
                                           cuda::internal::TaskStrided3DLaunch<TaskType>));
...
public:
  ...
  static vtkm::exec::cuda::internal::TaskStrided1DWorklet<
      WorkletType, OutToInPortalType, VisitPortalType, ThreadToOutPortalType, vtkm::cont::DeviceAdapterTagCuda, ExecutionObjectTypes...>
      MakeTask(
  ...
  {
    return vtkm::exec::cuda::internal::TaskStrided1DWorklet<
        WorkletType, OutToInPortalType, VisitPortalType, ThreadToOutPortalType, vtkm::cont::DeviceAdapterTagCuda, ExecutionObjectTypes...>(
          worklet,
          outToInPortal,
          visitPortal,
  ...
  template <typename WorkletType,
            ...
            typename ThreadToOutPortalType,
            typename... ExecutionObjectTypes>
  static vtkm::exec::cuda::internal::TaskStrided3DWorklet<
      WorkletType, OutToInPortalType, VisitPortalType, ThreadToOutPortalType, vtkm::cont::DeviceAdapterTagCuda, ExecutionObjectTypes...>
      MakeTask(
      const WorkletType& worklet,
      const OutToInPortalType& outToInPortal,
      ...
      ExecutionObjectTypes&&... executionObjects)
  {
    return vtkm::exec::cuda::internal::TaskStrided3DWorklet<
        WorkletType, OutToInPortalType, VisitPortalType, ThreadToOutPortalType, vtkm::cont::DeviceAdapterTagCuda, ExecutionObjectTypes...>(
          worklet,
          outToInPortal,
          visitPortal,
