...
public:
  ...
  static vtkm::exec::kokkos::internal::TaskBasic1DWorklet<
      WorkletType, OutToInPortalType, VisitPortalType, ThreadToOutPortalType, vtkm::cont::DeviceAdapterTagKokkos, ExecutionObjectTypes...>
      MakeTask(
  ...
  {
    return vtkm::exec::kokkos::internal::TaskBasic1DWorklet<
        WorkletType, OutToInPortalType, VisitPortalType, ThreadToOutPortalType, vtkm::cont::DeviceAdapterTagKokkos, ExecutionObjectTypes...>(
          worklet,
          outToInPortal,
          visitPortal,
  ...
  template <typename WorkletType,
            ...
            typename ThreadToOutPortalType,
            typename... ExecutionObjectTypes>
  static vtkm::exec::kokkos::internal::TaskBasic3DWorklet<
      WorkletType, OutToInPortalType, VisitPortalType, ThreadToOutPortalType, vtkm::cont::DeviceAdapterTagKokkos, ExecutionObjectTypes...>
      MakeTask(
      const WorkletType& worklet,
      const OutToInPortalType& outToInPortal,
      ...
      ExecutionObjectTypes&&... executionObjects)
  {
    return vtkm::exec::kokkos::internal::TaskBasic3DWorklet<
        WorkletType, OutToInPortalType, VisitPortalType, ThreadToOutPortalType, vtkm::cont::DeviceAdapterTagKokkos, ExecutionObjectTypes...>(
          worklet,
          outToInPortal,
          visitPortal,
