...
public:
  ...
  VTKM_EXEC void operator()(vtkm::Id idx,
                            ...
                            vtkm::Id& pixelIndex) const
  {
    vtkm::Int32 i = static_cast<vtkm::Int32>(idx % SubsetWidth);
    vtkm::Int32 j = static_cast<vtkm::Int32>(idx / SubsetWidth);
    i += Minx;
    j += Miny;
    // Write out the global pixelId
    pixelIndex = static_cast<vtkm::Id>(j * w + i);
//    pixelIndex = static_cast<vtkm::Int32>(idx / this->SubsetWidth);
