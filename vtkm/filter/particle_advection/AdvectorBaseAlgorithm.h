...
#ifndef vtk_m_filter_particle_advection_AdvectorBaseAlgorithm_h
#define vtk_m_filter_particle_advection_AdvectorBaseAlgorithm_h
...
#include <vtkm/filter/particle_advection/ParticleMessenger.h>
...
vtkm::cont::PartitionedDataSet RunAlgo(const vtkm::filter::particle_advection::BoundsMap& boundsMap,
...
{
public:
  AdvectorBaseAlgorithm(const vtkm::filter::particle_advection::BoundsMap& bm,
  ...
  virtual void Go()
  {
    vtkm::filter::particle_advection::ParticleMessenger messenger(
...
protected:
  ...
  virtual void Communicate(vtkm::filter::particle_advection::ParticleMessenger& messenger,
  ...
  vtkm::filter::particle_advection::BoundsMap BoundsMap;
