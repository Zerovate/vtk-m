...
{
  using AlgorithmType = vtkm::filter::particle_advection::PathParticleAlgorithm;
  using ThreadedAlgorithmType = vtkm::filter::particle_advection::PathParticleThreadedAlgorithm;
