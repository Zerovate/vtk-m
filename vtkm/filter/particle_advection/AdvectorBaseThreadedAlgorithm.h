...
#ifndef vtk_m_filter_particle_advection_AdvectorBaseThreadedAlgorithm_h
#define vtk_m_filter_particle_advection_AdvectorBaseThreadedAlgorithm_h
...
{
public:
  AdvectorBaseThreadedAlgorithm(const vtkm::filter::particle_advection::BoundsMap& bm,
