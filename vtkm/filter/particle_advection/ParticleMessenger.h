...
#ifndef vtk_m_filter_particle_advection_ParticleMessenger_h
#define vtk_m_filter_particle_advection_ParticleMessenger_h

#include <vtkm/Particle.h>
#include <vtkm/cont/Serialization.h>
#include <vtkm/filter/particle_advection/BoundsMap.h>
#include <vtkm/filter/particle_advection/Messenger.h>
...
class VTKM_FILTER_PARTICLE_ADVECTION_EXPORT ParticleMessenger
  : public vtkm::filter::particle_advection::Messenger
{
  //sendRank, message
...
public:
  VTKM_CONT ParticleMessenger(vtkmdiy::mpi::communicator& comm,
                              const vtkm::filter::particle_advection::BoundsMap& bm,
                              int msgSz = 1,
...
protected:
  ...
  VTKM_CONT bool RecvAny(std::vector<MsgCommType>* msgs,
                         ...
                         bool blockAndWait);
  const vtkm::filter::particle_advection::BoundsMap& BoundsMap;
