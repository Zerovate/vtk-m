...
#ifndef vtk_m_worklet_particle_advection_Particles_h
#define vtk_m_worklet_particle_advection_Particles_h
...
public:
  ...
  void StatusUpdate(const vtkm::Id& idx,
                    const vtkm::worklet::particle_advection::IntegratorStatus& status,
                    vtkm::Id maxSteps)
  {
...
{
public:
  VTKM_CONT vtkm::worklet::particle_advection::ParticleExecutionObject<ParticleType>
  PrepareForExecution(vtkm::cont::DeviceAdapterId device, vtkm::cont::Token& token) const
  {
    return vtkm::worklet::particle_advection::ParticleExecutionObject<ParticleType>(
...
public:
  ...
  VTKM_CONT vtkm::worklet::particle_advection::StateRecordingParticleExecutionObject<ParticleType>
  PrepareForExecution(vtkm::cont::DeviceAdapterId device, vtkm::cont::Token& token) const
  {
    return vtkm::worklet::particle_advection::StateRecordingParticleExecutionObject<ParticleType>(
      this->ParticleArray,
      this->HistoryArray,
...
#endif // vtk_m_worklet_particle_advection_Particles_h
//============================================================================
