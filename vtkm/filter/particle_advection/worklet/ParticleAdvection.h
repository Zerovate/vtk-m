...
#include <vtkm/filter/particle_advection/worklet/ParticleAdvectionWorklets.h>
...
public:
  ...
  ParticleAdvectionResult<ParticleType> Run(
    ...
    vtkm::Id MaxSteps)
  {
    vtkm::worklet::particle_advection::ParticleAdvectionWorklet<IntegratorType, ParticleType>
      worklet;
...
public:
  ...
  StreamlineResult<ParticleType> Run(
    ...
    vtkm::Id MaxSteps)
  {
    vtkm::worklet::particle_advection::StreamlineWorklet<IntegratorType, ParticleType> worklet;
